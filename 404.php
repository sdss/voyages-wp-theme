				...
				<main id="main" class="site-main">
					...
					<section class="error-404 not-found gx-card-content">
						...
						<header class="page-header">
							<h1 class="page-title">
								<?php esc_html_e( 'Page not found', 'galaxis' ); ?>
							</h1>
						</header><!-- .page-header -->

						<div class="page-content">
							<p><?php esc_html_e( 'Sorry, but we could not find a page with that address. Please try again, or use the search box below.', 'galaxis' ); ?></p>
